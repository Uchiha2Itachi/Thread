...
public abstract class BigExcelReader{
    ...
    public static StuClass stuClass = null;
    public static List<StuClass> list = new ArrayList<StuClass>();
        ...
        try {
            ...
            BigExcelReader reader = new BigExcelReader(filepath) {
                ...
                protected void outputRow(String[] datas, int[] rowTypes, int rowIndex)  {
                    ...
                    stuClass.setId(datas[0]);
                    stuClass.setStuName(datas[1]);
                    stuClass.setTeaName(datas[2]);
                    stuClass.setClassName(datas[3]);
                    list.add(stuClass);
            ...
            reader.parse();
            jdbc.doStore(list);
            System.out.println("总时间为："+(System.currentTimeMillis()-start)+"ms");
        } catch (IOException e) {
            e.printStackTrace();
